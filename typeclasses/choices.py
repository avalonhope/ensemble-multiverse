"""
Choices
Choices are connectors between Scenes. An exit always has a destination property
...
class Choice(DefaultExit):
    """
    Choices are connectors between scenes. Choices are normal Objects except
